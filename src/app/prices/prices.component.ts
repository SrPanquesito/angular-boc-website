...
export class PricesComponent implements OnInit {
  services: Services = {
    general: [
      ...
      {name: 'Composite Filling', boc_price: '$80 - $100'},
      {name: 'Temporary partial (Flipper)', boc_price: '$80 - $100', extra: 'up to 3 Units'},
    ...
    cosmetic: [
      ...
      {name: 'Whitening take home kit', boc_price: '$200'},
    ],
    implants: [
      {name: 'Single Dental Implant', boc_price: '$1000'},
      {name: 'All on 4 - X', boc_price: '$15,000', extra: 'per Arch'},
    ...
    oral_surgery: [
      {name: 'Tooth Extraction', boc_price: '$120'},
      {name: 'Tooth Extraction with Bone Graft (Socket Preservation)', boc_price: '$350'},
